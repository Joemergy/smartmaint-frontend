...
const Header = () => {
  ...
  const rutasAutenticadas = ['/admin', '/superadmin', '/super-admin', '/usuario', '/dashboard-usuario', '/mis-tareas', '/crear-tarea', '/historial-tareas-admin', '/historial-tareas-usuario', '/perfil-admin', '/perfil-usuario', '/dashboard-tareas'];
